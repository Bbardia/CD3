...
[GitHub security advisories](https://github.com/Bbardia/CD3/security/advisories/new) please do
not open a public issue for anything exploitable. You should hear back within a week.
...
authenticating proxy an instance reachable by an attacker is not a vulnerability in CD3, it is
...
Desktop builds are unsigned (no Apple/Windows signing identity) verify you downloaded from
